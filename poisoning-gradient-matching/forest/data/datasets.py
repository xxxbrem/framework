...
def construct_datasets(dataset, data_path, normalize=True):
    ...
    if dataset == 'CIFAR100':
        ...
        trainset = CIFAR10(root=data_path, train=True, download=False, transform=transforms.ToTensor())
    ...
    if dataset == 'CIFAR100':
        ...
        validset = CIFAR10(root=data_path, train=False, download=False, transform=transform_valid)
    elif dataset == 'MNIST':
